...
EventEmitter.prototype.removeListener = function(a, b) {
    var c;
    "object" === typeof this.events[a] && (c = this.indexOf(this.events[a], b), -1 < c && this.events[a].splice(c, 1))
};
EventEmitter.prototype.emit = function(a) {
    var b, c, d, e = [].slice.call(arguments, 1);
    if ("object" === typeof this.events[a])
        for (c = this.events[a].slice(), d = c.length, b = 0; b < d; b++) c[b].apply(this, e)
};
...
var loadScript = function(a, b, c) {
        return new Promise(function(d, e) {
            ...
            f.async = !0;
            f.src = a;
            for (var h = $jscomp.makeIterator(Object.entries(b || {})), g = h.next(); !g.done; g = h.next()) g = g.value, f.setAttribute(g[0], g[1]);
            f.onload = function() {
...
YouTubePlayer = function(a, b) {
    ...
    this._id = d.id ? d.id : d.id = "ytplayer-" + Math.random().toString(16).slice(2, 8);
    ...
    !this.replayInterval.find(function(a) {
        ...
        interval: setInterval(function() {
            if (b._player.getCurrentTime() >= b._player.getDuration() - Number(a)) {
                b.seek(0);
                for (var c = $jscomp.makeIterator(b.replayInterval.entries()), d = c.next(); !d.done; d = c.next()) d = d.value[0], Object.hasOwnProperty.call(b.replayInterval, d) && (clearInterval(b.replayInterval[d].interval),
    ...
    if (this._player) {
        ...
        if (b) {
            ...
            if (c = b.parentElement) {
                ...
                d = c.clientHeight + parseFloat(e.marginTop, 10) + parseFloat(e.marginBottom, 10) + parseFloat(e.borderTopWidth, 10) + parseFloat(e.borderBottomWidth, 10);
                c = c.clientWidth + parseFloat(e.marginLeft, 10) + parseFloat(e.marginRight, 10) + parseFloat(e.borderLeftWidth, 10) + parseFloat(e.borderRightWidth, 10);
                d += 80;
                b.style.width = c + "px";
                b.style.height =
                    Math.ceil(parseFloat(b.style.width, 10) / 1.7) + "px";
                b.style.marginTop = Math.ceil(-((parseFloat(b.style.height, 10) - d) / 2)) + "px";
                b.style.marginLeft = 0;
                if (e = parseFloat(b.style.height, 10) < d) b.style.height = d + "px", b.style.width = Math.ceil(1.7 * parseFloat(b.style.height, 10)) + "px", b.style.marginTop = 0, b.style.marginLeft = Math.ceil(-((parseFloat(b.style.width, 10) - c) / 2)) + "px";
                for (var f in a)
                    if (a.hasOwnProperty(f)) switch (a[f].replace(/ /g, "")) {
                        case "top":
                            b.style.marginTop = e ? -((parseFloat(b.style.height, 10) - d) / 2) + "px" :
                                0;
                            break;
                        case "bottom":
                            b.style.marginTop = e ? 0 : -(parseFloat(b.style.height, 10) - d) + "px";
                            break;
                        case "left":
                            b.style.marginLeft = 0;
                            break;
                        case "right":
                            b.style.marginLeft = e ? -(parseFloat(b.style.width, 10) - c) : "0px";
                            break;
                        default:
...
YouTubePlayer.prototype.stopReplay = function(a) {
    for (var b = $jscomp.makeIterator(this.replayInterval.entries()), c = b.next(); !c.done; c = b.next()) c = c.value[0], Object.hasOwnProperty.call(this.replayInterval, c) && a === this.replayInterval[c].iframeParent && (clearInterval(this.replayInterval[c].interval), this.replayInterval.splice(c, 1))
};
...
YouTubePlayer.prototype._destroy = function(a) {
    this.destroyed || (this.destroyed = !0, this._player && (this._player.stopVideo && this._player.stopVideo(), this._player.destroy()), this._player = this._api = this._opts = this._id = this.videoId = null, this._ready = !1, this._queue = null, this._stopInterval(), this.removeListener("playing", this._startInterval), this.removeListener("paused", this._stopInterval), this.removeListener("buffering", this._stopInterval), this.removeListener("unstarted", this._stopInterval), this.removeListener("ended",
        this._stopInterval), a && this.emit("error", a))
};
...
YouTubePlayer.prototype._loadIframeAPI = function(a) {
    ...
    window.onYouTubeIframeAPIReady = function() {
        for ("function" === typeof b && b(); loadIframeAPICallbacks.length;) loadIframeAPICallbacks.shift()(null,
            window.YT)
    }
};
